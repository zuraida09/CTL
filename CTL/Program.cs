    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                ACTGibbsSampling sourceModel = new ACTGibbsSampling();
                ...
                ACTGibbsSampling targetModel = new ACTGibbsSampling();
                ...
                CTLGibbsSampling collaborationModel = new CTLGibbsSampling(sourceModel, targetModel);
